...
const fakeAsync = async x => await x * 2;
const fake = x => fromAsyncCall(fakeAsync, x);
const fakeP = toPooled("fake", x => fake(fake(fake(fake(x)))) + fake(x), { fake });
console.log(fakeP(1));
//const state = toPooled("ls", (a, b) => ls(a + b).concat(ls(a + b)), { ls })(".", "/");
(async function ()
{
//    console.log(fakeP + "");
//    console.log(await toPromise(Object, fakeP(1)));
//    return;
    await 3;
    console.log(getFilenames3+"");
    console.log(await toPromise(Object,
        getFilenames3("/Users/tolmasky/Development/tonic",
        List(string)(["app/**/*.js"]))));
})();


const getFilenames3 = (function ()
{
...
const getFilenames2 = (function ()
{
    const glob = (...args) => Asynchronous.from(Object, () => require("fast-glob")(...args));
    const path = require("path");
    const resolve = workspace => pattern =>
        path.resolve(workspace,
            pattern.startsWith("/") ? pattern.substr(1) : pattern);
...
const ls = path => Asynchronous.from(Object, () => require("fs").promises.readdir(path));
//console.log(toPooled("ls", (a, b) => 10 + ls(a + b) + ls(a+b), { ls })+"");
//console.log(toPooled("ls", (a, b) => ls(a + b).concat(ls(a + b)), { ls })+"");
//const state = toPooled("ls", (a, b) => 10 + ls(a + b) + 20 + ls(a + b), { ls })(".", "/");
const state = getFilenames2("/Users/tolmasky/Development/tonic", List(string)(["app/**/*.js"]));
//const state = toPooled("ls", (a, b) => ls(a + b).concat(ls(a + b)), { ls })(".", "/");
